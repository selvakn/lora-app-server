...
func init() {
	...
	viper.BindEnv("application_server.internal_api.public_host", "AS_PUBLIC_SERVER")
	...
	viper.BindPFlag("application_server.internal_api.public_host", rootCmd.PersistentFlags().Lookup("as-public-server"))
