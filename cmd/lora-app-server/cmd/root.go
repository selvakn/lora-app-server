...
func init() {
	...
	rootCmd.PersistentFlags().String("postgres-dsn", "postgres://localhost/loraserver?sslmode=disable", "")
	...
	rootCmd.PersistentFlags().Int("gw-ping-frequency", 0, "")
	rootCmd.PersistentFlags().Int("gw-ping-dr", 0, "")
	...
	viper.BindEnv("application_server.password_hash_iterations", "PW_HASH_ITERATIONS")
	viper.BindEnv("application_server.internal_api.bind", "BIND")
	viper.BindEnv("application_server.internal_api.ca_cert", "CA_CERT")
	viper.BindEnv("application_server.internal_api.tls_cert", "TLS_CERT")
	viper.BindEnv("application_server.internal_api.tls_key", "TLS_KEY")
	viper.BindEnv("application_server.internal_api.public_server", "AS_PUBLIC_SERVER")
	viper.BindEnv("application_server.internal_api.public_id", "AS_PUBLIC_ID")
	...
	viper.BindPFlag("application_server.password_hash_iterations", rootCmd.PersistentFlags().Lookup("pw-hash-iterations"))
	viper.BindPFlag("application_server.internal_api.bind", rootCmd.PersistentFlags().Lookup("bind"))
	viper.BindPFlag("application_server.internal_api.ca_cert", rootCmd.PersistentFlags().Lookup("ca-cert"))
	viper.BindPFlag("application_server.internal_api.tls_cert", rootCmd.PersistentFlags().Lookup("tls-cert"))
	viper.BindPFlag("application_server.internal_api.tls_key", rootCmd.PersistentFlags().Lookup("tls-key"))
	viper.BindPFlag("application_server.internal_api.public_server", rootCmd.PersistentFlags().Lookup("as-public-server"))
	viper.BindPFlag("application_server.internal_api.public_id", rootCmd.PersistentFlags().Lookup("as-public-id"))
